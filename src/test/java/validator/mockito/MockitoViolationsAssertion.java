...
public class MockitoViolationsAssertion {
    private final List<FieldAssertion> expectedFields = new ArrayList<>();

    public static MockitoViolationsAssertion create() {
        return new MockitoViolationsAssertion();
    }
    ...
    public class FieldAssertion {
        ...
        public MockitoViolationsAssertion and() {
            return MockitoViolationsAssertion.this;
        }
